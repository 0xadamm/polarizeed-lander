            ...
            <div className="relative z-10 p-6 md:p-12">
              ...
              <div className="flex items-start space-x-4 mb-12 max-w-3xl">
                ...
                <p className="text-white text-lg">
                  Unlike traditional supplements that degrade in digestion, Nano
                  Strips use nano-encapsulation to deliver nutrients directly
                  into the bloodstream for immediate effects.
                </p>
              </div>
            </div>
          </div>
